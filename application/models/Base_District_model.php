...
{
	function get_district($fetchFields,$where,$order)
	{
		$CI = & get_instance();
		$CI->load->model('Base_get_model');
	    return $this->Base_get_model->get_list(tab_m('district'),$fetchFields,$where,$order);
	}
	...
	public function insert($arr)
	{
		...
		return $CI->Base_update_model->insert(tab_m('district'),$arr);
	}
	...
	public function delete($where)
	{
		$CI = & get_instance();
		$CI->load->model('Base_update_model');
		return $CI->Base_update_model->delete(tab_m('district'),$where);
	}
	...
	public function update($data,$where)
	{
		$CI = & get_instance();
		$CI->load->model('Base_update_model');
		return $CI->Base_update_model->update(tab_m('district'),$data,$where);
	}
	...
	public function get_row($where)
	{
		$CI = & get_instance();
		$CI->load->model('Base_get_model');
		return $CI->Base_get_model->get_row(tab_m('district'),'*',$where);
	}
