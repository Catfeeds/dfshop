<?php /* Smarty version 2.6.20, created on 2017-07-21 11:30:29
         compiled from cart_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'cart_list.htm', 412, false),)), $this); ?>
...
">
                        <div class="div_center">
                            ...
                            <span>库存数:<b><?php echo $this->_tpl_vars['i']['product_info']['stock']; ?>
</b></span>
                        ...
                        <div class="div_right">
                            ...
                            <input type="hidden" value="<?php echo $this->_tpl_vars['i']['product_id']; ?>
">
...
//                }
    ...
    function plusw(obj){
        ...
        var gc_id = $this.siblings("input").val(); /*商品id*/
    ...
    {
        $.post('<?php echo ((is_array($_tmp="cart/cart_goods_num_change")) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
',{num:num,goods_id:goods_id},function(msg){
            try
            {
                //alert(msg)
                eval("var str="+msg);
    ...
    {
        $.post('<?php echo ((is_array($_tmp="cart/cart_goods_delete")) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
',{goods_id:goods_id},function(msg){
            try
            {
                //alert(msg)
                eval("var str="+msg);
