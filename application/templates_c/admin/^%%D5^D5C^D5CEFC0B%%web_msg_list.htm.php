<?php /* Smarty version 2.6.20, created on 2017-07-25 09:31:57
         compiled from web_msg_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'web_msg_list.htm', 58, false),)), $this); ?>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-search"></i>公告搜索</div>
                ...
                <div>
                    <div>
                        ...
                        <form action="" method="post" id="product_all">
                            <span onclick="alertWin('添加公告',800,400,'<?php echo ((is_array($_tmp="admin_index/web_msg_list")) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
/?act=add')" class="btn red">添加公告</span>
                            <table class="table table-striped table-bordered table-hover dataTable" id="product_1" >
                                ...
                                <tr role="heading">
                                    ...
                                    <th width="150"  class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">公告标题</th>
                                    <th width="*"  class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">添加时间</th>
                                </tr>
                                </thead>
...
">删除</button>
                                        <button type="button"  class="btn mini green "  onclick="alertWin('编辑公告',800,400,'<?php echo ((is_array($_tmp="admin_index/web_msg_list")) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
    ...
    var product_shelves=function()
    {
        $('.product_process').click(function(){
            ...
            if(type=='edit')
            {
                    ...
                    $.post('<?php echo ((is_array($_tmp="admin_index/web_msg_list")) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
