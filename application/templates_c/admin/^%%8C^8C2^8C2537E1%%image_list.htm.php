<?php /* Smarty version 2.6.20, created on 2017-07-25 09:32:10
         compiled from image_list.htm */ ?>
        ...
        <table class="table table-striped table-bordered table-hover dataTable" id="product_1" >
          <thead>
            <tr role="heading">
              ...
              <th width="60" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">上传UID</th>
              <th width="90" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">图片</th>
              <th width="*" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">上传文件名</th>
              <th width="150" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">上传时间</th>
            </tr>
          </thead>
...
?>
                <tr>
                  <td><a  class="btn red" onClick="return confirm('删除图片');" href="?del_id=<?php echo $this->_tpl_vars['item']['id']; ?>
&url=<?php echo $this->_tpl_vars['item']['url']; ?>
">删除</a></td>
                  <td><?php echo $this->_tpl_vars['item']['id']; ?>
</td>                  
                  <td><?php echo $this->_tpl_vars['item']['user_id']; ?>
</td>
                  <td><img width="80" src="<?php echo $this->_tpl_vars['item']['url']; ?>
"></td>
                  <td><?php echo $this->_tpl_vars['item']['upload_name']; ?>
</td> 
